// ネイティブ(android/src/main/kotlin/com/moongift/offline_stt_android/
// AndroidTranscribeError.ktのwireCode)に依存しない純粋なエラーコード
// 文字列->TranscribeException写像のみを検証する。
// 切り分け方針は lib/src/error_code_mapping.dart 冒頭コメントを参照。

import 'package:offline_stt_android/src/error_code_mapping.dart';
