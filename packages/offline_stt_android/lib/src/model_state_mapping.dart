...
/// `pigeon.ModelState.name`を渡す。offline_stt_darwinと同じ構成)。
///
/// Kotlin側(`android/src/main/kotlin/com/moongift/offline_stt_android/
...
/// `offline_stt_platform_interface`の[ModelState]へ変換するだけであり、
...
/// [StateError]を投げる(offline_stt_web/offline_stt_darwinの
