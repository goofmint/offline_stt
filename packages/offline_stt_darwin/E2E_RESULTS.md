...
| clip | macOS 26.5.1 | iOS 26.6.2 | 判定 | M0 スパイク(macOS) |
|---|---|---|---|---|
| jaJP_10s.wav | 4/6 = **66.7%** | 4/6 = **66.7%** | 不成立 | 66.7% |
| jaJP_10s.m4a | 4/6 = **66.7%** | 4/6 = **66.7%** | 不成立 | 記録なし |
| enUS_10s.wav | 4/5 = **80.0%** | 4/5 = **80.0%** | 不成立 | 80.0% |
| enUS_10s.m4a | 4/5 = **80.0%** | 4/5 = **80.0%** | 不成立 | 記録なし |
| jaJP_3m.wav | 11/28 = **39.3%** | 11/28 = **39.3%** | 不成立 | 39.3% |
| jaJP_3m.m4a | 8/28 = **28.6%** | 8/28 = **28.6%** | 不成立 | 28.6% |
| enUS_3m.wav | 11/25 = **44.0%** | 11/25 = **44.0%** | 不成立 | 44.0% |
| enUS_3m.m4a | 11/25 = **44.0%** | 11/25 = **44.0%** | 不成立 | 44.0% |
...
- **M0 スパイク(macOS、`.progressiveTranscription`)の値とも一致した。**
  本番実装への移植で精度は変わっていない。
- 同じ音声の wav と m4a で **jaJP_3m だけ 39.3% → 28.6% と差が出た**。
