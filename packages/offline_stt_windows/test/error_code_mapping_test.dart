// ネイティブ(windows/windows_transcribe_error.cpp の WireCode())に依存
...
import 'package:offline_stt_windows/src/error_code_mapping.dart';
...
void main() {
  group('mapNativeErrorCode', () {
    ...
    test('localeUnsupported は LocaleUnsupportedException へ写像する', () {
      // design.md §4.4 のとおりWindowsネイティブ実装はこのcodeを発生させない
      // (ロケール指定APIが存在しないため)が、Android/Darwinと対応表を
      // 揃えておくため写像自体は用意してある。
      expect(
