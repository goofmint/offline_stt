...
結果は [E2E_RESULTS_DARWIN.md](E2E_RESULTS_DARWIN.md) にある**(macOS 26.5.1 と
...
- **OS**: macOS 26 以上 / iOS 26 以上(requirements.md NFR-4)。
  ...
  **対応下限である iOS 26 実機での確認は済んでいる**(iPad Pro 11-inch (M4)
  / iOS 26.6.2。spikes/darwin/RESULTS.md と E2E_RESULTS_DARWIN.md)。
...
確定した**(E2E_RESULTS_DARWIN.md の F-1 / F-2)。上表の「発火方法」はこの2件に
ついては現状の実装では成立しない。
